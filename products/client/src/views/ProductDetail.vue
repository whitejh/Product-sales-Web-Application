<template>
  <main class="mt-3">
    <div class="container">
          ...
          <div class="card shadow-sm" style="width:50em;">
            <div class="card-body">
              ...
              <p class="card-text pb-3">
                배송비 {{ getCurrencyFormat(productDetail.delivery_price) }}원 | 도서산간(제주도) 배송비 추가 {{ getCurrencyFormat(productDetail.add_delivery_price) }}원 | 택배배송 |
                ...
                <div class="row">
                  ...
                  <div class="col-auto">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" style="width:50px; text-align:center" v-model="total" />
                      <span class="input-group-text" style="cursor:pointer" @click="calculatePrice(1)">+</span>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-12">
          <img :src="productDetail.path" class="img-fluid" alt="" />
        </div>
      </div>
    </div>
  </main>
